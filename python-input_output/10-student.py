#!/usr/bin/python3
"""
Module defines Student class with enhanced to_json method that can return
specific attributes of class instance.
"""
...
class Student:
    ...
    def to_json(self, attrs=None):
        ...
        Args:
            attrs (list, optional): List of strings representing names of
                                    attributes to be included in resulting
                                    dictionary.
