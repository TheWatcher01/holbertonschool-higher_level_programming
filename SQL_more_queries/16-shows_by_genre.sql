...
FROM
    tv_shows
    /* Perform LEFT JOIN with 'show_genres' table based on matching 'id' in 'tv_shows'
    ...
    /* Perform another LEFT JOIN with 'tv_genres' table based on matching 'genre_id' in 'show_genres' &
    'id' in 'tv_genres'.
    This connects genre names to shows. */
